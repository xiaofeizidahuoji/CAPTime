...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None, data_path='ETTh1.csv',
                 scale=True, seasonal_patterns=None, drop_short=False, model_name='gpt2', percent=100,):
        self.seq_len = size[0]
    ...
    def __read_data__(self):
        ...
        self.data_x = data[border1:border2]  # [N,7] 
        self.data_y = data[border1:border2]  # [N1,7]
    ...
    def __getitem__(self, index):
        ...
        seq_x_mark = torch.randn((self.token_num, self.hidden_dim))
        seq_y_mark = torch.randn((self.token_num, self.hidden_dim))
...
class Dataset_ETT_minute(Dataset):
    ...
    def __getitem__(self, index):
        ...
        r_begin = s_end - self.label_len
        r_end = r_begin + self.label_len + self.pred_len
        # print(s_begin, s_end, feat_id, r_begin, r_end)  # e.g. 5696 6368 2 5792 6464
        seq_x = self.data_x[s_begin:s_end, feat_id:feat_id+1]
        seq_y = self.data_y[r_begin:r_end, feat_id:feat_id+1]
        seq_x_mark = torch.randn((self.token_num, self.hidden_dim))
        seq_y_mark = torch.randn((self.token_num, self.hidden_dim))
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.scale:
            ...
            data = df_data.values
        data_name = self.data_path.split('.')[0]
        self.data_stamp = torch.load(os.path.join(self.root_path, f'{data_name}_{self.model_name}.pt'))
...
class Dataset_Custom_notime(Dataset):
    def __init__(self, root_path, flag='train', size=None, data_path='ETTh1.csv',
                 scale=True, seasonal_patterns=None, drop_short=False, model_name='gpt2',percent=100):
        self.seq_len = size[0]
        self.label_len = size[1]
...
class Dataset_M4(Dataset):
    def __init__(self, root_path, flag='pred', size=None, data_path='ETTh1.csv',
                 scale=False, inverse=False, seasonal_patterns='Yearly', drop_short=False, model_name='gpt2',percent=100):
        self.scale = scale
...
class Dataset_text():
    def __init__(self, root_path, flag='train', size=None,
                 data_path='ETTh1.csv', scale=True, seasonal_patterns=None, model_name='gpt2'):
        pass
    ...
    def setup(self, scaler, data, dataset='Health'):
        if dataset in ['Climate', 'Energy', 'Environment', 'Health', 'Traffictext']:
            self._cached_params = (data.mean(), data.std())
            scaler.fit(data)
